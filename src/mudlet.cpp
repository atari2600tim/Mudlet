...
QString mudlet::getMudletPath(const mudletPathType mode, const QString& extra1, const QString& extra2)
{
    ...
    case mainPath:
        ...
        return QStringLiteral("%1/.config/mudlet").arg(mudlet::self()->homePath);
    case mainDataItemPath:
        ...
        // argument does:
        return QStringLiteral("%1/.config/mudlet/%2").arg(mudlet::self()->homePath, extra1);
    case mainFontsPath:
        // (Added for 3.5.0) a revised location to store Mudlet provided fonts
        return QStringLiteral("%1/.config/mudlet/fonts").arg(mudlet::self()->homePath);
    case profilesPath:
        // The directory containing all the saved user's profiles - does not end
        // in '/'
        return QStringLiteral("%1/.config/mudlet/profiles").arg(mudlet::self()->homePath);
    case profileHomePath:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2").arg(mudlet::self()->homePath, extra1);
    case profileMediaPath:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/media").arg(mudlet::self()->homePath, extra1);
    case profileMediaPathFileName:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/media/%3").arg(mudlet::self()->homePath, extra1, extra2);
    case profileXmlFilesPath:
        // Takes one extra argument (profile name) that returns the directory
        // for the profile game save XML files - ends in a '/'
        return QStringLiteral("%1/.config/mudlet/profiles/%2/current/").arg(mudlet::self()->homePath, extra1);
    case profileMapsPath:
        // Takes one extra argument (profile name) that returns the directory
        // for the profile game save maps files - does NOT end in a '/'
        return QStringLiteral("%1/.config/mudlet/profiles/%2/map").arg(mudlet::self()->homePath, extra1);
    case profileDateTimeStampedMapPathFileName:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/map/%3map.dat").arg(mudlet::self()->homePath, extra1, extra2);
    case profileDateTimeStampedJsonMapPathFileName:
        // Takes two extra arguments (profile name, dataTime stamp) that returns
        // the pathFile name for a dateTime stamped JSON map file:
        return QStringLiteral("%1/.config/mudlet/profiles/%2/map/%3map.json").arg(mudlet::self()->homePath, extra1, extra2);
    case profileMapPathFileName:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/map/%3").arg(mudlet::self()->homePath, extra1, extra2);
    case profileXmlMapPathFileName:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/map.xml").arg(mudlet::self()->homePath, extra1);
    case profileDataItemPath:
        ...
        // SlySven):
        return QStringLiteral("%1/.config/mudlet/profiles/%2/%3").arg(mudlet::self()->homePath, extra1, extra2);
    ...
    case profileReplayAndLogFilesPath:
        ...
        return QStringLiteral("%1/.config/mudlet/profiles/%2/log").arg(mudlet::self()->homePath, extra1);
    case profileLogErrorsFilePath:
        ...
        // map is loaded:
        return QStringLiteral("%1/.config/mudlet/profiles/%2/log/errors.txt").arg(mudlet::self()->homePath, extra1);
    case editorWidgetThemePathFile:
        ...
        if (extra1.compare(QStringLiteral("Mudlet.tmTheme"), Qt::CaseSensitive)) {
            // No match
            return QStringLiteral("%1/.config/mudlet/edbee/Colorsublime-Themes-master/themes/%2").arg(mudlet::self()->homePath, extra1);
        } else {
    ...
    case editorWidgetThemeJsonFile:
        ...
        return QStringLiteral("%1/.config/mudlet/edbee/Colorsublime-Themes-master/themes.json").arg(mudlet::self()->homePath);
    case moduleBackupsPath:
        ...
        return QStringLiteral("%1/.config/mudlet/moduleBackups/").arg(mudlet::self()->homePath);
